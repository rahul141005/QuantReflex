...
|---|---|---|
| **Bible Version** | 2.27 | The documentation set as a whole (these `/docs/BIBLE/` files). |
| **Architecture Version** | 2.17 | App topology, service boundaries, data-flow contracts. |
