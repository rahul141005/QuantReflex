...
|---|---|---|
| **Bible Version** | 2.31 | The documentation set as a whole (these `/docs/BIBLE/` files). |
| **Architecture Version** | 2.18 | App topology, service boundaries, data-flow contracts. |
