...
|---|---|---|
| **Bible Version** | 2.33 | The documentation set as a whole (these `/docs/BIBLE/` files). |
| **Architecture Version** | 2.19 | App topology, service boundaries, data-flow contracts. |
