...
|---|---|---|
| **Bible Version** | 2.21 | The documentation set as a whole (these `/docs/BIBLE/` files). |
| **Architecture Version** | 2.13 | App topology, service boundaries, data-flow contracts. |
