...
|---|---|---|
| **Bible Version** | 2.20 | The documentation set as a whole (these `/docs/BIBLE/` files). |
| **Architecture Version** | 2.12 | App topology, service boundaries, data-flow contracts. |
| **Firestore Version** | 2.12 | Collection/field/path schema + indexes. |
