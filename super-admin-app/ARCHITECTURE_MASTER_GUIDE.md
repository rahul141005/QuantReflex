...
- **Premium Tier (₹349/6mo, ₹599/12mo):** One paid tier that includes everything — unlimited practice, all modes, the full AI suite (explanations, coach, study plans, word problems), Math Duel, and deeper analytics. Admins can also grant custom-duration trials.
