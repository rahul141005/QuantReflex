...
(function () {
  ...
  eq('3 arithmetic topicCount', byId.arithmetic && byId.arithmetic.topicCount, 9);
  ...
  eq('3 published gold-standard count = 62', KB.all().filter(function (t) { return t.status === 'published'; }).length, 62);
...
(function () {
  ...
  eq('3b bySubject(quant) covers all 36 Quant topics', KB.bySubject('quant').length, 36);
