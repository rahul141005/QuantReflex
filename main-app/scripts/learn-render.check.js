...
ok('exam → kx-exam list', (function () { var n = BR.render({ type: 'exam', title: 'Strategy', items: ['skip the hard one', { text: 'eliminate options' }] }); return hasClass(n, 'kx-exam') && txtIncludes(n, 'skip the hard one') && txtIncludes(n, 'eliminate options'); })());
ok('sectionLabel: concept uses its title', BR.sectionLabel({ type: 'concept', title: 'The overlap of +1' }) === 'The overlap of +1' && BR.sectionLabel({ type: 'formula' }) === 'Key Formulae');
